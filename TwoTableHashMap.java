...
public class TwoTableHashMap<K, V> implements Map<K, V> {
    ...
    private class HashMapIterator implements Iterator<K> {
        ...
        HashMapIterator() {
            for (int i = 0; i < TwoTableHashMap.this.hashSize; i++) {
                if (TwoTableHashMap.this.data1.get(i) != null) {
                    this.tempData.add(TwoTableHashMap.this.data1.get(i));
                }
                if (HashMap.this.data2.get(i) != null) {
                    this.tempData.add(TwoTableHashMap.this.data2.get(i));
                }
            }
        }
